...
public class BullsAndCows extends JFrame implements ActionListener {
    ...
    public void createAppForm() {
        ...
        setResizable(false);
        setTitle("Bulls and Cows: The Java Edition");
        ...
        //add a text area with cyan border around it and scrollbars
    ...
    public void runGuesses(String numString) {
        int bulls = 0;
        int cows = 0;
        ...
        if ((guess / 1000) <= 0 || (guess / 1000) >= 10) {
            JOptionPane.showMessageDialog(null, "Please enter a four digit" +
                    "number without repeats or 0.");
            numOfGuesses--;
        }

        //game won
        else if (guess == number) {
            textArea.append("You won the game. The number was " + number + "." + NEWLINE +
